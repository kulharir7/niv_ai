...
def get_system_prompt(conversation_id: str = None) -> str:
    ...
    default_prompt = (
        ...
        "Be concise, highly professional, and proactive. When a task is ambiguous, "
        "ask for clarification. Format data in clear tables with proper number formatting.\n\n"
        ...
        "1. For every non-trivial request, wrap your internal reasoning in <thought> tags.\n"
        "2. Inside <thought>, explain what you understand, what tools you'll use, and why.\n"
        "3. Example: <thought>User wants a sales summary. I need to list Sales Invoices for this month and then calculate the total.</thought>\n\n"
