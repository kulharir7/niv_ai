...
def get_system_prompt(conversation_id: str = None) -> str:
    ...
    default_prompt = (
        ...
        "MANDATORY: You MUST begin EVERY response with an internal reasoning process wrapped in <thought> and </thought> tags. "
        "Explain your plan, tool selection, and logic inside these tags. Only AFTER the </thought> tag, provide your final response to the user.\n\n"
